# R program to analyze the Microarray Dataset GSE96053
# for diffenertially expressed genes, then performed the gene set enrichment
# analysis, both in pathway analysis and in Gene Ontology terms
# DEGs are identified by linear modeling, DEGs are also reported in interactive 
# graphs

#Gordon Liu @July 22, 2017 modified on July 29 after identifying a mislabelled
#sample according to published paper by the Genetech people
################################################################
#cleaning the memory
getwd()
remove(list = ls())
...
workingFolder <- paste('C:\\BigData\\Microarray\\GSE96053CorrectedLabel')
setwd(workingFolder)
getwd()
destdir
